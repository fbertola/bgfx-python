...
void bind_unknown_unknown(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // bgfx::CallbackI file:bgfx.h line:418
		...
		cl.def("cacheReadSize", (unsigned int (bgfx::CallbackI::*)(unsigned long long)) &bgfx::CallbackI::cacheReadSize, "Returns the size of a cached item. Returns 0 if no cached item was\n found.\n\n \n Cache id.\n \n\n Number of bytes to read.\n\n \n C99 equivalent is `bgfx_callback_vtbl.cache_read_size`.\n\nC++: bgfx::CallbackI::cacheReadSize(unsigned long long) --> unsigned int", pybind11::arg("_id"), pybind11::call_guard<pybind11::gil_scoped_release>());
		cl.def("cacheRead", (bool (bgfx::CallbackI::*)(unsigned long long, void *, unsigned int)) &bgfx::CallbackI::cacheRead, "Read cached item.\n\n \n Cache id.\n \n\n Buffer where to read data.\n \n\n Size of data to read.\n\n \n True if data is read.\n\n \n C99 equivalent is `bgfx_callback_vtbl.cache_read`.\n\nC++: bgfx::CallbackI::cacheRead(unsigned long long, void *, unsigned int) --> bool", pybind11::arg("_id"), pybind11::arg("_data"), pybind11::arg("_size"), pybind11::call_guard<pybind11::gil_scoped_release>());
		cl.def("cacheWrite", (void (bgfx::CallbackI::*)(unsigned long long, const void *, unsigned int)) &bgfx::CallbackI::cacheWrite, "Write cached item.\n\n \n Cache id.\n \n\n Data to write.\n \n\n Size of data to write.\n\n \n C99 equivalent is `bgfx_callback_vtbl.cache_write`.\n\nC++: bgfx::CallbackI::cacheWrite(unsigned long long, const void *, unsigned int) --> void", pybind11::arg("_id"), pybind11::arg("_data"), pybind11::arg("_size"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_4(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// bgfx::isTextureValid(unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long) file:bgfx.h line:2581
	M("bgfx").def("isTextureValid", (bool (*)(unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long)) &bgfx::isTextureValid, "Validate texture parameters.\n\n \n Depth dimension of volume texture.\n \n\n Indicates that texture contains cubemap.\n \n\n Number of layers in texture array.\n \n\n Texture format. See: `TextureFormat::Enum`.\n \n\n Texture flags. See `BGFX_TEXTURE_*`.\n \n\n True if texture can be successfully created.\n\n \n C99 equivalent is `bgfx_is_texture_valid`.\n\nC++: bgfx::isTextureValid(unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long) --> bool", pybind11::arg("_depth"), pybind11::arg("_cubeMap"), pybind11::arg("_numLayers"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
{
	// bgfx::createTexture(const struct bgfx::Memory *, unsigned long long, unsigned char, struct bgfx::TextureInfo *) file:bgfx.h line:2629
	...
	M("bgfx").def("createTexture", [](const struct bgfx::Memory * a0, unsigned long long const & a1) -> bgfx::TextureHandle { return bgfx::createTexture(a0, a1); }, "", pybind11::arg("_mem"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("createTexture", [](const struct bgfx::Memory * a0, unsigned long long const & a1, unsigned char const & a2) -> bgfx::TextureHandle { return bgfx::createTexture(a0, a1, a2); }, "", pybind11::arg("_mem"), pybind11::arg("_flags"), pybind11::arg("_skip"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("createTexture", (struct bgfx::TextureHandle (*)(const struct bgfx::Memory *, unsigned long long, unsigned char, struct bgfx::TextureInfo *)) &bgfx::createTexture, "Create texture from memory buffer.\n\n \n DDS, KTX or PVR texture data.\n \n\n Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`)\n   flags. Default texture sampling mode is linear, and wrap mode is repeat.\n   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap\n     mode.\n   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic\n     sampling.\n\n \n Skip top level mips when parsing texture.\n \n\n When non-`NULL` is specified it returns parsed texture information.\n \n\n Texture handle.\n\n \n C99 equivalent is `bgfx_create_texture`.\n\nC++: bgfx::createTexture(const struct bgfx::Memory *, unsigned long long, unsigned char, struct bgfx::TextureInfo *) --> struct bgfx::TextureHandle", pybind11::arg("_mem"), pybind11::arg("_flags"), pybind11::arg("_skip"), pybind11::arg("_info"), pybind11::call_guard<pybind11::gil_scoped_release>());

	// bgfx::createTexture2D(unsigned short, unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *) file:bgfx.h line:2657
	...
	M("bgfx").def("createTexture2D", [](unsigned short const & a0, unsigned short const & a1, bool const & a2, unsigned short const & a3, enum bgfx::TextureFormat::Enum const & a4, unsigned long long const & a5) -> bgfx::TextureHandle { return bgfx::createTexture2D(a0, a1, a2, a3, a4, a5); }, "", pybind11::arg("_width"), pybind11::arg("_height"), pybind11::arg("_hasMips"), pybind11::arg("_numLayers"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("createTexture2D", (struct bgfx::TextureHandle (*)(unsigned short, unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *)) &bgfx::createTexture2D, "Create 2D texture.\n\n \n Width.\n \n\n Height.\n \n\n Indicates that texture contains full mip-map chain.\n \n\n Number of layers in texture array. Must be 1 if caps\n   `BGFX_CAPS_TEXTURE_2D_ARRAY` flag is not set.\n \n\n Texture format. See: `TextureFormat::Enum`.\n \n\n Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`)\n   flags. Default texture sampling mode is linear, and wrap mode is repeat.\n   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap\n     mode.\n   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic\n     sampling.\n\n \n Texture data. If `_mem` is non-NULL, created texture will be immutable. If\n   `_mem` is NULL content of the texture is uninitialized. When `_numLayers` is more than\n   1, expected memory layout is texture and all mips together for each array element.\n\n \n C99 equivalent is `bgfx_create_texture_2d`.\n\nC++: bgfx::createTexture2D(unsigned short, unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *) --> struct bgfx::TextureHandle", pybind11::arg("_width"), pybind11::arg("_height"), pybind11::arg("_hasMips"), pybind11::arg("_numLayers"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::arg("_mem"), pybind11::call_guard<pybind11::gil_scoped_release>());

	// bgfx::createTexture2D(enum bgfx::BackbufferRatio::Enum, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long) file:bgfx.h line:2685
	...
	M("bgfx").def("createTexture2D", (struct bgfx::TextureHandle (*)(enum bgfx::BackbufferRatio::Enum, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long)) &bgfx::createTexture2D, "Create texture with size based on backbuffer ratio. Texture will maintain ratio\n if back buffer resolution changes.\n\n \n Frame buffer size in respect to back-buffer size. See:\n   `BackbufferRatio::Enum`.\n \n\n Indicates that texture contains full mip-map chain.\n \n\n Number of layers in texture array. Must be 1 if caps\n   `BGFX_CAPS_TEXTURE_2D_ARRAY` flag is not set.\n \n\n Texture format. See: `TextureFormat::Enum`.\n \n\n Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`)\n   flags. Default texture sampling mode is linear, and wrap mode is repeat.\n   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap\n     mode.\n   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic\n     sampling.\n\n \n C99 equivalent is `bgfx_create_texture_2d_scaled`.\n\nC++: bgfx::createTexture2D(enum bgfx::BackbufferRatio::Enum, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long) --> struct bgfx::TextureHandle", pybind11::arg("_ratio"), pybind11::arg("_hasMips"), pybind11::arg("_numLayers"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());

	// bgfx::createTexture3D(unsigned short, unsigned short, unsigned short, bool, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *) file:bgfx.h line:2712
	...
	M("bgfx").def("createTexture3D", [](unsigned short const & a0, unsigned short const & a1, unsigned short const & a2, bool const & a3, enum bgfx::TextureFormat::Enum const & a4, unsigned long long const & a5) -> bgfx::TextureHandle { return bgfx::createTexture3D(a0, a1, a2, a3, a4, a5); }, "", pybind11::arg("_width"), pybind11::arg("_height"), pybind11::arg("_depth"), pybind11::arg("_hasMips"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("createTexture3D", (struct bgfx::TextureHandle (*)(unsigned short, unsigned short, unsigned short, bool, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *)) &bgfx::createTexture3D, "Create 3D texture.\n\n \n Width.\n \n\n Height.\n \n\n Depth.\n \n\n Indicates that texture contains full mip-map chain.\n \n\n Texture format. See: `TextureFormat::Enum`.\n \n\n Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`)\n   flags. Default texture sampling mode is linear, and wrap mode is repeat.\n   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap\n     mode.\n   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic\n     sampling.\n\n \n Texture data. If `_mem` is non-NULL, created texture will be immutable. If\n   `_mem` is NULL content of the texture is uninitialized.\n\n \n C99 equivalent is `bgfx_create_texture_3d`.\n\nC++: bgfx::createTexture3D(unsigned short, unsigned short, unsigned short, bool, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *) --> struct bgfx::TextureHandle", pybind11::arg("_width"), pybind11::arg("_height"), pybind11::arg("_depth"), pybind11::arg("_hasMips"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::arg("_mem"), pybind11::call_guard<pybind11::gil_scoped_release>());

	// bgfx::createTextureCube(unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *) file:bgfx.h line:2742
	...
	M("bgfx").def("createTextureCube", [](unsigned short const & a0, bool const & a1, unsigned short const & a2, enum bgfx::TextureFormat::Enum const & a3, unsigned long long const & a4) -> bgfx::TextureHandle { return bgfx::createTextureCube(a0, a1, a2, a3, a4); }, "", pybind11::arg("_size"), pybind11::arg("_hasMips"), pybind11::arg("_numLayers"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("createTextureCube", (struct bgfx::TextureHandle (*)(unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *)) &bgfx::createTextureCube, "Create Cube texture.\n\n \n Cube side size.\n \n\n Indicates that texture contains full mip-map chain.\n \n\n Number of layers in texture array. Must be 1 if caps\n   `BGFX_CAPS_TEXTURE_CUBE_ARRAY` flag is not set.\n \n\n Texture format. See: `TextureFormat::Enum`.\n \n\n Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`)\n   flags. Default texture sampling mode is linear, and wrap mode is repeat.\n   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap\n     mode.\n   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic\n     sampling.\n\n \n Texture data. If `_mem` is non-NULL, created texture will be immutable. If\n   `_mem` is NULL content of the texture is uninitialized. When `_numLayers` is more than\n   1, expected memory layout is texture and all mips together for each array element.\n\n \n C99 equivalent is `bgfx_create_texture_cube`.\n\nC++: bgfx::createTextureCube(unsigned short, bool, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long, const struct bgfx::Memory *) --> struct bgfx::TextureHandle", pybind11::arg("_size"), pybind11::arg("_hasMips"), pybind11::arg("_numLayers"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::arg("_mem"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_6(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// bgfx::createFrameBuffer(unsigned short, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long) file:bgfx.h line:2931
	...
	M("bgfx").def("createFrameBuffer", (struct bgfx::FrameBufferHandle (*)(unsigned short, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long)) &bgfx::createFrameBuffer, "Create frame buffer (simple).\n\n \n Texture width.\n \n\n Texture height.\n \n\n Texture format. See: `TextureFormat::Enum`.\n \n\n Default texture sampling mode is linear, and wrap mode\n   is repeat.\n   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap\n     mode.\n   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic\n     sampling.\n\n \n Handle to frame buffer object.\n\n \n C99 equivalent is `bgfx_create_frame_buffer`.\n\nC++: bgfx::createFrameBuffer(unsigned short, unsigned short, enum bgfx::TextureFormat::Enum, unsigned long long) --> struct bgfx::FrameBufferHandle", pybind11::arg("_width"), pybind11::arg("_height"), pybind11::arg("_format"), pybind11::arg("_textureFlags"), pybind11::call_guard<pybind11::gil_scoped_release>());

	// bgfx::createFrameBuffer(enum bgfx::BackbufferRatio::Enum, enum bgfx::TextureFormat::Enum, unsigned long long) file:bgfx.h line:2955
	...
	M("bgfx").def("createFrameBuffer", (struct bgfx::FrameBufferHandle (*)(enum bgfx::BackbufferRatio::Enum, enum bgfx::TextureFormat::Enum, unsigned long long)) &bgfx::createFrameBuffer, "Create frame buffer with size based on backbuffer ratio. Frame buffer will maintain ratio\n if back buffer resolution changes.\n\n \n Frame buffer size in respect to back-buffer size. See:\n   `BackbufferRatio::Enum`.\n \n\n Texture format. See: `TextureFormat::Enum`.\n \n\n Default texture sampling mode is linear, and wrap mode\n   is repeat.\n   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap\n     mode.\n   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic\n     sampling.\n\n \n Handle to frame buffer object.\n\n \n C99 equivalent is `bgfx_create_frame_buffer_scaled`.\n\nC++: bgfx::createFrameBuffer(enum bgfx::BackbufferRatio::Enum, enum bgfx::TextureFormat::Enum, unsigned long long) --> struct bgfx::FrameBufferHandle", pybind11::arg("_ratio"), pybind11::arg("_format"), pybind11::arg("_textureFlags"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_8(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// bgfx::setState(unsigned long long, unsigned int) file:bgfx.h line:3421
	M("bgfx").def("setState", [](unsigned long long const & a0) -> void { return bgfx::setState(a0); }, "", pybind11::arg("_state"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("setState", (void (*)(unsigned long long, unsigned int)) &bgfx::setState, "Set render states for draw primitive.\n\n \n State flags. Default state for primitive type is\n   triangles. See: `BGFX_STATE_DEFAULT`.\n   - `BGFX_STATE_DEPTH_TEST_*` - Depth test function.\n   - `BGFX_STATE_BLEND_*` - See remark 1 about BGFX_STATE_BLEND_FUNC.\n   - `BGFX_STATE_BLEND_EQUATION_*` - See remark 2.\n   - `BGFX_STATE_CULL_*` - Backface culling mode.\n   - `BGFX_STATE_WRITE_*` - Enable R, G, B, A or Z write.\n   - `BGFX_STATE_MSAA` - Enable MSAA.\n   - `BGFX_STATE_PT_[TRISTRIP/LINES/POINTS]` - Primitive type.\n\n \n Sets blend factor used by `BGFX_STATE_BLEND_FACTOR` and\n   `BGFX_STATE_BLEND_INV_FACTOR` blend modes.\n\n \n\n   1. To setup more complex states use:\n      `BGFX_STATE_ALPHA_REF(_ref)`,\n      `BGFX_STATE_POINT_SIZE(_size)`,\n      `BGFX_STATE_BLEND_FUNC(_src, _dst)`,\n      `BGFX_STATE_BLEND_FUNC_SEPARATE(_srcRGB, _dstRGB, _srcA, _dstA)`\n      `BGFX_STATE_BLEND_EQUATION(_equation)`\n      `BGFX_STATE_BLEND_EQUATION_SEPARATE(_equationRGB, _equationA)`\n   2. `BGFX_STATE_BLEND_EQUATION_ADD` is set when no other blend\n      equation is specified.\n\n \n C99 equivalent is `bgfx_set_state`.\n\nC++: bgfx::setState(unsigned long long, unsigned int) --> void", pybind11::arg("_state"), pybind11::arg("_rgba"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_10(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// bgfx::overrideInternal(struct bgfx::TextureHandle, unsigned long) file:bgfx/platform.h line:99
	M("bgfx").def("overrideInternal", (unsigned long (*)(struct bgfx::TextureHandle, unsigned long)) &bgfx::overrideInternal, "Override internal texture with externally created texture. Previously\n created internal texture will released.\n\n \n It's expected you understand some bgfx internals before you\n   use this call.\n\n \n Texture handle.\n \n\n Native API pointer to texture.\n\n \n Native API pointer to texture. If result is 0, texture is not created yet from the\n   main thread.\n\n \n Must be called only on render thread.\n\n \n C99 equivalent is `bgfx_override_internal_texture_ptr`.\n\nC++: bgfx::overrideInternal(struct bgfx::TextureHandle, unsigned long) --> unsigned long", pybind11::arg("_handle"), pybind11::arg("_ptr"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
{
	// bgfx::overrideInternal(struct bgfx::TextureHandle, unsigned short, unsigned short, unsigned char, enum bgfx::TextureFormat::Enum, unsigned long long) file:bgfx/platform.h line:126
	M("bgfx").def("overrideInternal", [](struct bgfx::TextureHandle const & a0, unsigned short const & a1, unsigned short const & a2, unsigned char const & a3, enum bgfx::TextureFormat::Enum const & a4) -> unsigned long { return bgfx::overrideInternal(a0, a1, a2, a3, a4); }, "", pybind11::arg("_handle"), pybind11::arg("_width"), pybind11::arg("_height"), pybind11::arg("_numMips"), pybind11::arg("_format"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("overrideInternal", (unsigned long (*)(struct bgfx::TextureHandle, unsigned short, unsigned short, unsigned char, enum bgfx::TextureFormat::Enum, unsigned long long)) &bgfx::overrideInternal, "Override internal texture by creating new texture. Previously created\n internal texture will released.\n\n \n It's expected you understand some bgfx internals before you\n   use this call.\n\n \n Texture handle.\n \n\n Width.\n \n\n Height.\n \n\n Number of mip-maps.\n \n\n Texture format. See: `TextureFormat::Enum`.\n \n\n Default texture sampling mode is linear, and wrap mode\n   is repeat.\n   - `BGFX_TEXTURE_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap\n     mode.\n   - `BGFX_TEXTURE_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic\n     sampling.\n\n \n Native API pointer to texture. If result is 0, texture is not created yet from the\n   main thread.\n\n \n Must be called only on render thread.\n\n \n C99 equivalent is `bgfx_override_internal_texture`.\n\nC++: bgfx::overrideInternal(struct bgfx::TextureHandle, unsigned short, unsigned short, unsigned char, enum bgfx::TextureFormat::Enum, unsigned long long) --> unsigned long", pybind11::arg("_handle"), pybind11::arg("_width"), pybind11::arg("_height"), pybind11::arg("_numMips"), pybind11::arg("_format"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
