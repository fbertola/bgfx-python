...
void bind_unknown_unknown(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	M("bgfx").def("isValid", (bool (*)(struct bgfx::VertexLayoutHandle)) &bgfx::isValid, "C++: bgfx::isValid(struct bgfx::VertexLayoutHandle) --> bool", pybind11::arg("_handle"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // bgfx::Caps file:bgfx.h line:714
		...
		{ // bgfx::Caps::Limits file:bgfx.h line:743
			...
			cl.def_readwrite("maxVertexLayouts", &bgfx::Caps::Limits::maxVertexLayouts);
	...
	{ // bgfx::TransientVertexBuffer file:bgfx.h line:812
		...
		cl.def_readwrite("layoutHandle", &bgfx::TransientVertexBuffer::layoutHandle);
	}
	...
	{ // bgfx::Stats file:bgfx.h line:934
		...
		cl.def_readwrite("numVertexLayouts", &bgfx::Stats::numVertexLayouts);
		...
		cl.def_readwrite("viewStats", &bgfx::Stats::viewStats);
		cl.def_readwrite("numEncoders", &bgfx::Stats::numEncoders);
		cl.def_readwrite("encoderStats", &bgfx::Stats::encoderStats);
	}
...
void bind_bgfx_2(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // bgfx::VertexLayout file:bgfx.h line:1669
		...
		cl.def("getOffset", (unsigned short (bgfx::VertexLayout::*)(enum bgfx::Attrib::Enum) const) &bgfx::VertexLayout::getOffset, "Returns relative attribute offset from the vertex.\n\nC++: bgfx::VertexLayout::getOffset(enum bgfx::Attrib::Enum) const --> unsigned short", pybind11::arg("_attrib"), pybind11::call_guard<pybind11::gil_scoped_release>());
		cl.def("getStride", (unsigned short (bgfx::VertexLayout::*)() const) &bgfx::VertexLayout::getStride, "Returns vertex stride.\n\nC++: bgfx::VertexLayout::getStride() const --> unsigned short", pybind11::call_guard<pybind11::gil_scoped_release>());
		cl.def("getSize", (unsigned int (bgfx::VertexLayout::*)(unsigned int) const) &bgfx::VertexLayout::getSize, "Returns size of vertex buffer for number of vertices.\n\nC++: bgfx::VertexLayout::getSize(unsigned int) const --> unsigned int", pybind11::arg("_num"), pybind11::call_guard<pybind11::gil_scoped_release>());
	}
	...
	M("bgfx").def("vertexConvert", [](const struct bgfx::VertexLayout & a0, void * a1, const struct bgfx::VertexLayout & a2, const void * a3) -> void { return bgfx::vertexConvert(a0, a1, a2, a3); }, "", pybind11::arg("_destLayout"), pybind11::arg("_destData"), pybind11::arg("_srcLayout"), pybind11::arg("_srcData"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("vertexConvert", (void (*)(const struct bgfx::VertexLayout &, void *, const struct bgfx::VertexLayout &, const void *, unsigned int)) &bgfx::vertexConvert, "Converts vertex stream data from one vertex stream format to another.\n\n \n Destination vertex stream layout.\n \n\n Destination vertex stream.\n \n\n Source vertex stream layout.\n \n\n Source vertex stream data.\n \n\n Number of vertices to convert from source to destination.\n\n \n C99 equivalent is `bgfx_vertex_convert`.\n\nC++: bgfx::vertexConvert(const struct bgfx::VertexLayout &, void *, const struct bgfx::VertexLayout &, const void *, unsigned int) --> void", pybind11::arg("_destLayout"), pybind11::arg("_destData"), pybind11::arg("_srcLayout"), pybind11::arg("_srcData"), pybind11::arg("_num"), pybind11::call_guard<pybind11::gil_scoped_release>());

	// bgfx::weldVertices(unsigned short *, const struct bgfx::VertexLayout &, const void *, unsigned short, float) file:bgfx.h line:1818
	M("bgfx").def("weldVertices", [](unsigned short * a0, const struct bgfx::VertexLayout & a1, const void * a2, unsigned short const & a3) -> unsigned short { return bgfx::weldVertices(a0, a1, a2, a3); }, "", pybind11::arg("_output"), pybind11::arg("_layout"), pybind11::arg("_data"), pybind11::arg("_num"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("weldVertices", (unsigned short (*)(unsigned short *, const struct bgfx::VertexLayout &, const void *, unsigned short, float)) &bgfx::weldVertices, "Weld vertices.\n\n \n Welded vertices remapping table. The size of buffer\n   must be the same as number of vertices.\n \n\n Vertex stream layout.\n \n\n Vertex stream.\n \n\n Number of vertices in vertex stream.\n \n\n Error tolerance for vertex position comparison.\n \n\n Number of unique vertices after vertex welding.\n\n \n C99 equivalent is `bgfx_weld_vertices`.\n\nC++: bgfx::weldVertices(unsigned short *, const struct bgfx::VertexLayout &, const void *, unsigned short, float) --> unsigned short", pybind11::arg("_output"), pybind11::arg("_layout"), pybind11::arg("_data"), pybind11::arg("_num"), pybind11::arg("_epsilon"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_3(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	M("bgfx").def("createVertexBuffer", [](const struct bgfx::Memory * a0, const struct bgfx::VertexLayout & a1) -> bgfx::VertexBufferHandle { return bgfx::createVertexBuffer(a0, a1); }, "", pybind11::arg("_mem"), pybind11::arg("_layout"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("createVertexBuffer", (struct bgfx::VertexBufferHandle (*)(const struct bgfx::Memory *, const struct bgfx::VertexLayout &, unsigned short)) &bgfx::createVertexBuffer, "Create static vertex buffer.\n\n \n Vertex buffer data.\n \n\n Vertex layout.\n \n\n Buffer creation flags.\n   - `BGFX_BUFFER_NONE` - No flags.\n   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.\n   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer\n       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.\n   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.\n   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of\n       data is passed. If this flag is not specified, and more data is passed on update, the buffer\n       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic\n       buffers.\n   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on\n       index buffers.\n \n\n Static vertex buffer handle.\n\n \n C99 equivalent is `bgfx_create_vertex_buffer`.\n\nC++: bgfx::createVertexBuffer(const struct bgfx::Memory *, const struct bgfx::VertexLayout &, unsigned short) --> struct bgfx::VertexBufferHandle", pybind11::arg("_mem"), pybind11::arg("_layout"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
	...
	M("bgfx").def("createDynamicVertexBuffer", [](unsigned int const & a0, const struct bgfx::VertexLayout & a1) -> bgfx::DynamicVertexBufferHandle { return bgfx::createDynamicVertexBuffer(a0, a1); }, "", pybind11::arg("_num"), pybind11::arg("_layout"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("createDynamicVertexBuffer", (struct bgfx::DynamicVertexBufferHandle (*)(unsigned int, const struct bgfx::VertexLayout &, unsigned short)) &bgfx::createDynamicVertexBuffer, "Create empty dynamic vertex buffer.\n\n \n Number of vertices.\n \n\n Vertex layout.\n \n\n Buffer creation flags.\n   - `BGFX_BUFFER_NONE` - No flags.\n   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.\n   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer\n       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.\n   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.\n   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of\n       data is passed. If this flag is not specified, and more data is passed on update, the buffer\n       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic\n       buffers.\n   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on\n       index buffers.\n \n\n Dynamic vertex buffer handle.\n\n \n C99 equivalent is `bgfx_create_dynamic_vertex_buffer`.\n\nC++: bgfx::createDynamicVertexBuffer(unsigned int, const struct bgfx::VertexLayout &, unsigned short) --> struct bgfx::DynamicVertexBufferHandle", pybind11::arg("_num"), pybind11::arg("_layout"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_4(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	M("bgfx").def("createDynamicVertexBuffer", [](const struct bgfx::Memory * a0, const struct bgfx::VertexLayout & a1) -> bgfx::DynamicVertexBufferHandle { return bgfx::createDynamicVertexBuffer(a0, a1); }, "", pybind11::arg("_mem"), pybind11::arg("_layout"), pybind11::call_guard<pybind11::gil_scoped_release>());
	M("bgfx").def("createDynamicVertexBuffer", (struct bgfx::DynamicVertexBufferHandle (*)(const struct bgfx::Memory *, const struct bgfx::VertexLayout &, unsigned short)) &bgfx::createDynamicVertexBuffer, "Create dynamic vertex buffer and initialize it.\n\n \n Vertex buffer data.\n \n\n Vertex layout.\n \n\n Buffer creation flags.\n   - `BGFX_BUFFER_NONE` - No flags.\n   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.\n   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer\n       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.\n   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.\n   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of\n       data is passed. If this flag is not specified, and more data is passed on update, the buffer\n       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic\n       buffers.\n   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on\n       index buffers.\n \n\n Dynamic vertex buffer handle.\n\n \n C99 equivalent is `bgfx_create_dynamic_vertex_buffer_mem`.\n\nC++: bgfx::createDynamicVertexBuffer(const struct bgfx::Memory *, const struct bgfx::VertexLayout &, unsigned short) --> struct bgfx::DynamicVertexBufferHandle", pybind11::arg("_mem"), pybind11::arg("_layout"), pybind11::arg("_flags"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_8(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	M("bgfx").def("setVertexBuffer", (void (*)(unsigned char, const struct bgfx::TransientVertexBuffer *, unsigned int, unsigned int, struct bgfx::VertexLayoutHandle)) &bgfx::setVertexBuffer, "Set vertex buffer for draw primitive.\n\n \n Vertex stream.\n \n\n Transient vertex buffer.\n \n\n First vertex to render.\n \n\n Number of vertices to render.\n \n\n Vertex layout for aliasing vertex buffer.\n\n \n C99 equivalent is `bgfx_set_transient_vertex_buffer`.\n\nC++: bgfx::setVertexBuffer(unsigned char, const struct bgfx::TransientVertexBuffer *, unsigned int, unsigned int, struct bgfx::VertexLayoutHandle) --> void", pybind11::arg("_stream"), pybind11::arg("_tvb"), pybind11::arg("_startVertex"), pybind11::arg("_numVertices"), pybind11::arg("_layoutHandle"), pybind11::call_guard<pybind11::gil_scoped_release>());
...
void bind_bgfx_9(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// bgfx::submit(unsigned short, struct bgfx::ProgramHandle, unsigned int, bool) file:bgfx.h line:3808
	...
	// bgfx::submit(unsigned short, struct bgfx::ProgramHandle, struct bgfx::OcclusionQueryHandle, unsigned int, bool) file:bgfx.h line:3826
	...
	// bgfx::submit(unsigned short, struct bgfx::ProgramHandle, struct bgfx::IndirectBufferHandle, unsigned short, unsigned short, unsigned int, bool) file:bgfx.h line:3848
	...
	// bgfx::dispatch(unsigned short, struct bgfx::ProgramHandle, unsigned int, unsigned int, unsigned int) file:bgfx.h line:3956
...
{
	// bgfx::dispatch(unsigned short, struct bgfx::ProgramHandle, struct bgfx::IndirectBufferHandle, unsigned short, unsigned short) file:bgfx.h line:3974
